...
#kubectl exec front -- curl ingress-link:9001 | head -n 5;
./shell.sh init front nginx;
./shell.sh init back tool;
./shell.sh exec front nginx curl ingress-link:9002 | head -n 5;
./shell.sh exec back tool curl ingress-link:9001 | head -n 5;
#kubectl exec back -- curl ingress-link:9001 | head -n 5;
