...
./shell.sh exec front tool curl back-service:9002 | head -n 5;
./shell.sh exec front tool curl --connect-timeout 5 cache-service:9003 | head -n 5;
./shell.sh exec back tool curl cache-service:9003 | head -n 5;
